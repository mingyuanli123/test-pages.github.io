<template>
	<div class="home">
		<div class="index_top">
      <div class="index_top_title"><img  style="width: 20px" :src="require('@/assets/logo.png')"/> WUHealthDine</div>
...
<script setup>
	...
	const getSession = () =>{
		context?.$http({
			...
			if(context?.$toolUtil.storageGet('frontSessionTable') == 'shangjia'){
				context?.$toolUtil.storageSet('headportrait',res.data.data.dianputupian)
			}
		})
	}
	init()
